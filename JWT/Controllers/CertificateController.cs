...
namespace JWT.Controllers
{
    ...
    public class CertificateController : Controller
    {
        ...
        [HttpGet]
        [Authorize]
        public async Task<String> CreatePdf(String empNIK, String id)
        {
            String path;
            ...
            {
                //sp1
                IEnumerable<EventSessionSurvey> eventSessionSurvey = await this.surveyAnswerPesertaProvider.GetEventSessionSurvey(Convert.ToInt32(id), empNIK);
                ...
                evtps = (from e in db.EventPeserta
                         ...
                         where e.EmpNIK == empNIK && e.EventID == Convert.ToInt32(id)
            ...
            Byte[] bytes = System.IO.File.ReadAllBytes("Resources/Output/Training Certificate.pdf");
