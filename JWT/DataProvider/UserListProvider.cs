...
namespace JWT.DataProvider
{
    ...
    public class UserListProvider : IUserListProvider
    {
        ...
        public async Task<IEnumerable<UserList>> GetUserList(string posId)
        {
            ...
            {               
                ...
                return await sqlConnection.QueryAsync<UserList>("spGetUserListDataPA", dynamicParameters, commandType: CommandType.StoredProcedure);
