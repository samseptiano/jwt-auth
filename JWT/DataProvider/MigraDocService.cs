...
namespace JWT.DataProvider
{
    ...
    {
        private readonly string _createdDocsPath = ".\\Resources\\Output";
        private readonly string _imagesPath = ".\\Resources\\Images";
        ...
        public string CreateMigraDocPdf(PdfData pdfData)
        {
            ...
            string mdddlName = $"{_createdDocsPath}/{pdfData.DocumentTitle}-{DateTime.UtcNow.ToOADate()}.mdddl";
        ...
        private Document CreateDocument(PdfData pdfData)
        {
            ...
            document.Info.Subject = pdfData.TrainingName;
            document.Info.Author = pdfData.Trainee;
